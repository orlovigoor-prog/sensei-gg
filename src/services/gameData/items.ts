...
export const itemCatalog: ItemCatalogEntry[] = [
  ...
  { id: 6333, name: 'Танец смерти', tags: ['fighter', 'survivability'], shortStats: ['60 силы атаки', '15 ускорения умений', '50 брони'], passiveTitle: 'Презрение к боли', passiveText: 'Часть полученного урона откладывается во времени, а убийства помогают быстро стабилизировать здоровье.', totalCost: 3300, combineCost: 525 },
  ...
  { id: 6665, name: 'Жак\' Шо', tags: ['tank', 'durability'], shortStats: ['350 здоровья', '45 брони', '45 сопротивления магии'], passiveTitle: 'Неумолимое поглощение', passiveText: 'Чем дольше длится бой, тем плотнее становится владелец, постепенно наращивая стойкость.', totalCost: 3200, combineCost: 700 },
